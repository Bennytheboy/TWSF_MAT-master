...
for test in range(1, 9):
    ...
    psspy.dyre_new([1, 1, 1, 1], CasePath + "Tamworth_SMIB_E161_E130_HVRT.dyr", '', '', '')
    if test == 1:
        OutputFilePath = FigurePath + '11. High Voltage Ride Through' + "\\" + 'Test0' + str(
            test + 8) + '_' + FileName + '_High Voltage Ride Through.out'
    else:
        OutputFilePath = FigurePath + '11. High Voltage Ride Through' + "\\" + 'Test' + str(
            test + 8) + '_' + FileName + '_High Voltage Ride Through.out'
